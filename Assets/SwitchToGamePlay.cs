...
public class SwitchToGame : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        m_adress = m_transport.ConnectionData.Address;
        m_port = m_transport.ConnectionData.Port.ToString();
    ...
    private void HandleHostButtonClicked()
    {
        ...
        m_transport.ConnectionData.Address = m_adress;
        m_transport.ConnectionData.ServerListenAddress = m_adress;
        m_transport.ConnectionData.Port = ushort.Parse(m_port);
